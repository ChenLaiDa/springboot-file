...
public class PdfController {
    ...
    public Result<?> myPdf(){
        // 定义保存路径
        final String outputPath = "D:\\my.pdf";
        // 定义分割线颜色
        ...
        XEasyPdfHandler.Document.build()
                ...
                .addPage(
                        ...
                        XEasyPdfHandler.Page.build(
                                // 构建文本
                                XEasyPdfHandler.Text.build("x-easypdf简介（细体）").setHorizontalStyle(XEasyPdfPositionStyle.CENTER).setFontSize(16F).setDefaultFontStyle(XEasyPdfDefaultFontStyle.LIGHT).enableDeleteLine()
                                // 构建文本
    ...
    public Result<?> pdfExport() {
        // 定义图片路径
        final String imagePath = "D:\\images\\aisi.jpg";
        // 定义保存路径
        final String outputPath = "D:\\my.pdf";
        // 定义页眉与页脚字体颜色
